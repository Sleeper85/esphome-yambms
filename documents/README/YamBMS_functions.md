...
- For BMS that never report balancing, see **Simulate Equalizing** (`packages/balancer/balancer_simulate_equalizing.yaml`) — optional and independent of Current Taper.
